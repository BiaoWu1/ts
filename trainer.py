...
class Trainer:
    def __init__(self, options):
        ...
        self.models["encoder_s"] = networks.test_hr_encoder.hrnet18(True)
        self.models["encoder_s"].num_ch_enc = [ 64, 18, 36, 72, 144 ]
        ...
        self.models["depth_s"] = networks.HRDepthDecoder(
            self.models["encoder_s"].num_ch_enc, self.opt.scales)
        
        self.models["depth_t"] = networks.HRDepthDecoder(
            self.models["encoder_t"].num_ch_enc, self.opt.scales)
        
        
        self.models["encoder_s"].to(self.device)
        self.parameters_to_train += list(self.models["encoder_s"].parameters())
        ...
        self.models["depth_s"].to(self.device)
        self.parameters_to_train += list(self.models["depth_s"].parameters())
